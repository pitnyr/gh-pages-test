...
var $author$project$Repl$Client$IO$lensWorkerCont = {
	getter: function (_v0) {
		var model = _v0.a;
		return model.workerCont;
	},
	setter: F2(
		function (workerCont, _v1) {
			var model = _v1.a;
			return $author$project$Repl$Client$IO$Model(
				_Utils_update(
					model,
					{workerCont: workerCont}));
		})
};
...
var $author$project$Repl$Client$IO$receiveFromWorkerPort = _Platform_incomingPort(
...
var $author$project$Repl$Client$IO$sendToWorkerPort = _Platform_outgoingPort('sendToWorkerPort', $elm$json$Json$Encode$string);
var $author$project$Repl$Client$IO$clientToWorkerRequester = A3($author$project$Repl$Api$clientToWorkerApi.requesterFun, $author$project$Repl$Client$IO$lensWorkerCont, $author$project$Repl$Client$IO$sendToWorkerPort, $author$project$Repl$Client$IO$receiveFromWorkerPort);
var $author$project$Repl$Client$IO$subscriptions = function (model) {
	return $author$project$Repl$Client$IO$clientToWorkerRequester.respond(model);
};
...
var $author$project$Repl$Client$IO$viewMaybeError = function (maybeError) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
...
var $author$project$Repl$Client$IO$ReplShown = function (a) {
...
var $author$project$Repl$Client$IO$lensReplState = {
	getter: function (_v0) {
		var model = _v0.a;
		return model.replState;
	},
	setter: F2(
		function (replState, _v1) {
			var model = _v1.a;
			return $author$project$Repl$Client$IO$Model(
				_Utils_update(
					model,
...
var $author$project$Repl$Client$IO$modifyShownModel = function (fun) {
	return A2(
		$author$project$Extra$System$IO$bind,
		$author$project$Extra$System$IO$getLens($author$project$Repl$Client$IO$lensReplState),
		function (replState) {
			if (replState.$ === 'ReplShown') {
				var shownModel = replState.a;
				return A2(
					$author$project$Extra$System$IO$putLens,
					$author$project$Repl$Client$IO$lensReplState,
					$author$project$Repl$Client$IO$ReplShown(
						fun(shownModel)));
			} else {
				return $author$project$Extra$System$IO$noOp;
			}
...
var $author$project$Repl$Client$IO$addOutput = function (newOutput) {
	return $author$project$Repl$Client$IO$modifyShownModel(
		function (shownModel) {
...
var $author$project$Repl$Client$IO$setInput = function (input) {
	return $author$project$Repl$Client$IO$modifyShownModel(
		function (shownModel) {
			return _Utils_update(
				shownModel,
...
var $author$project$Repl$Client$IO$setPrefill = function (prefill) {
	return $author$project$Repl$Client$IO$modifyShownModel(
		function (shownModel) {
			return _Utils_update(
				shownModel,
...
var $author$project$Repl$Client$IO$callWorker = function (input) {
	return A2(
		$author$project$Extra$System$IO$bind,
		$author$project$Repl$Client$IO$clientToWorkerRequester.request(
			{userInput: input}),
		function (workerResponse) {
			...
			if (_v0.$ === 'WorkerStateRunning') {
				...
				return $author$project$Extra$System$IO$sequence(
					_List_fromArray(
						[
							$author$project$Repl$Client$IO$setInput(
							A2($elm$core$Maybe$withDefault, '', maybePrefill)),
							$author$project$Repl$Client$IO$setPrefill(maybePrefill),
							$author$project$Repl$Client$IO$addOutput(workerResponse.messages)
						]));
			} else {
				...
				return A2(
					$author$project$Extra$System$IO$putLens,
					$author$project$Repl$Client$IO$lensReplState,
					$author$project$Repl$Client$IO$ReplHidden(maybeError));
			}
		});
};
var $author$project$Repl$Client$IO$showButtonClicked = $author$project$Extra$System$IO$sequence(
	_List_fromArray(
		[
			A2(
			$author$project$Extra$System$IO$putLens,
			...
			$author$project$Repl$Client$IO$callWorker('')
		]));
var $author$project$Repl$Client$IO$viewShowButton = _List_fromArray(
	[
		A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onClick($author$project$Repl$Client$IO$showButtonClicked)
			]),
		_List_fromArray(
			[
...
var $author$project$Repl$Client$IO$viewReplHidden = function (maybeError) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_Utils_ap(
			_List_Nil,
			_Utils_ap(
				$author$project$Repl$Client$IO$viewMaybeError(maybeError),
				$author$project$Repl$Client$IO$viewShowButton)));
};
var $elm$html$Html$form = _VirtualDom_node('form');
var $author$project$Repl$Client$IO$promptString = function (maybePrefill) {
...
var $author$project$Repl$Client$IO$formSubmitted = A2(
	$author$project$Extra$System$IO$bind,
	$author$project$Extra$System$IO$getLens($author$project$Repl$Client$IO$lensReplState),
	function (replState) {
		if (replState.$ === 'ReplHidden') {
			return $author$project$Extra$System$IO$noOp;
		} else {
			var shownModel = replState.a;
			return $author$project$Extra$System$IO$sequence(
				_List_fromArray(
					[
						$author$project$Repl$Client$IO$addOutput(
						_List_fromArray(
							[
								_Utils_ap(
								$author$project$Repl$Client$IO$promptString(shownModel.prefill),
								shownModel.input)
							])),
						$author$project$Repl$Client$IO$callWorker(shownModel.input)
					]));
		}
	});
var $elm$html$Html$input = _VirtualDom_node('input');
var $author$project$Repl$Client$IO$inputChanged = function (newInput) {
	return $author$project$Repl$Client$IO$setInput(newInput);
};
...
var $author$project$Repl$Client$IO$viewInput = F2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onSubmit($author$project$Repl$Client$IO$formSubmitted)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Repl$Client$IO$promptString(maybePrefill))
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Repl$Client$IO$inputChanged)
							]),
						_List_Nil)
					]))
			]);
...
var $author$project$Repl$Client$IO$adjustTrailingNewLines = function (text) {
	return A2($elm$core$String$endsWith, '\n', text) ? ($elm$core$String$trimRight(text) + '\n\n') : text;
};
var $elm$html$Html$pre = _VirtualDom_node('pre');
var $author$project$Repl$Client$IO$viewOutputEntry = function (entry) {
	return A2(
		$elm$html$Html$pre,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$Repl$Client$IO$adjustTrailingNewLines(entry))
			]));
};
var $author$project$Repl$Client$IO$viewOutput = function (output) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			...
			A2($elm$core$List$map, $author$project$Repl$Client$IO$viewOutputEntry, output))
		]);
};
var $author$project$Repl$Client$IO$viewReplShown = function (shownModel) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_Utils_ap(
			_List_Nil,
			_Utils_ap(
				$author$project$Repl$Client$IO$viewOutput(shownModel.output),
				A2($author$project$Repl$Client$IO$viewInput, shownModel.prefill, shownModel.input))));
};
var $author$project$Repl$Client$IO$view = function (_v0) {
	var model = _v0.a;
	var _v1 = model.replState;
	if (_v1.$ === 'ReplHidden') {
		var maybeError = _v1.a;
		return $author$project$Repl$Client$IO$viewReplHidden(maybeError);
	} else {
		var shownModel = _v1.a;
		return $author$project$Repl$Client$IO$viewReplShown(shownModel);
	}
};
